...
void test_mag()
{
	TEST_ASSERT_EQUAL(20, magnitude(-20));
	TEST_ASSERT_EQUAL(30, magnitude(30));
	TEST_ASSERT_EQUAL(2, magnitude(-2));
}

void test_posnum()
{
	TEST_ASSERT_EQUAL(false, posnum(-20));
	TEST_ASSERT_EQUAL(true, posnum(30));
	TEST_ASSERT_EQUAL(false, posnum(0));
}

/* void test_negnum()
{
	TEST_ASSERT_EQUAL(false, negnum(-20));
	TEST_ASSERT_EQUAL(true, negnum(30));
	TEST_ASSERT_EQUAL(true, negnum(0));
} */

void test_add()
{
	int8_t output1 = add(10, 20);
	TEST_ASSERT_EQUAL(30, output1);
	int8_t output2 = add(100, 200);
	TEST_ASSERT_EQUAL(300,output2);
	// int8_t output3 = add(100, 200);
	// TEST_ASSERT_EQUAL(45,output3);
}
...
void test_power()
{
	int8_t output1 = power(2, 3);
	TEST_ASSERT_EQUAL(8, output1);
	int8_t output2 = power(20, 2);
	TEST_ASSERT_EQUAL(400,output2);
}
...
void test_is_equal()
{
	int8_t output1 = is_equal(10, 10);
	TEST_ASSERT_TRUE(output1);
	int8_t output2 = is_equal(500, 500);
	TEST_ASSERT_TRUE(output2);
