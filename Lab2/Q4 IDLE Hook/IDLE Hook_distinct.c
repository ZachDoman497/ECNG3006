...
static const char *TAG = "IDLE_DISTINCT";

// Idle hook – counts how often the idle task runs
void vApplicationIdleHook(void)
{
    idleCount++;
}

// Monitor task – prints idle cycles every second
...
void app_main()
{
    ...
    ESP_LOGI(TAG, "Tasks created with distinct priorities.");
}
